...
/**
 * @class: NIOForFiles
 * @description: Performs a simple test to compare the efficiency of NIO against
 *               the older Buffered IO implementation. My tests suggest NIO
 *               outperforms BufferedReading by a significant margin; however,
 *               BufferedWriting appears to have the advantage over NIO.
 *               Somewhat odd results; however, the below code should
 *               consistently suggest the same. These results may be effected by
 *               the size of the allocated ByteBuffer. OOM errors occurring from
 *               large ByteBuffers required reduced size relative to the
 *               BufferedWriter--though, that may be more reason to favor the
 *               old way.
 * @author: Sherman
 */
