...
public class Base64Converter {
	...
	static public byte[] convertBinaryToBase64(byte[] from) {
		return convertBinaryToBase64(from, from.length, false);
	}
	 ...
	 * a binary byte array of the specified length. Includes carriage returns and
	 * all.
	 * 
	 * @param input_size  -
	 * @param line_breaks -
	 ...
	 */
	public static class Base64FormatException extends IOException {
